...
# rrv_sigma_voig=RooRealVar("rrv_sigma_voig"+label+"_"+self.channel+"_"+self.wtagger_label,"rrv_sigma_voig"+label+"_"+self.channel+"_"+self.wtagger_label,40,10,100);
    ...
    def get_WJets_mlvj_correction_sb_lo_to_signal_region(self,label, mlvj_model):#exo-vv method: extract M_lvj shape of signal_region from sb_lo
        ...
        mplot = rrv_x.frame(RooFit.Title("correlation_pdf"), RooFit.Bins(int(rrv_x.getBins()/self.narrow_factor))) ; mplot.GetYaxis().SetTitle("arbitrary units");
...
1+self.signal_jet_energy_res_uncertainty));
    ...
    def prepare_limit(self,mode):
        ...
        else: shape_para_error_alpha=1.0;
