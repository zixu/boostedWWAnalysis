...
class doFit_wj_and_wlvj:
    ...
    def fit_mj_single_MC(self,in_file_name, label, in_model_name, additioninformation=""):
      ...
      rfresult = model.fitTo(rdataset_mj,RooFit.Save(1), RooFit.Extended(kTRUE), RooFit.Minimizer("Minuit2") );
      ...
      self.draw_canvas_with_pull( mplot,mplot_pull,parameters_list,"plots_%s_%s_%s_%s/m_j_fitting%s_wtaggercut%s_nPV%sto%s/"%(options.additioninformation,self.channel,self.wtagger_label,
