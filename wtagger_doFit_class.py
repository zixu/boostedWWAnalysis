...
class doFit_wj_and_wlvj:
    def __init__(self, in_channel="mu",in_higgs_sample="ggH600", in_mlvj_signal_region_min=500, in_mlvj_signal_region_max=700, in_mj_min=30, in_mj_max=140, in_mlvj_min=400., in_mlvj_max=1400., fit_model="ErfExp_v1", fit_model_alter="ErfPow_v1", input_workspace=None):
        ...
        if options.fitwtagger or options.fitwtaggersim:
            self.file_Directory="/uscms_data/d3/zixu/Data/WTagger/otrees_ExoLeptonID_Analysis/trainingtrees_%s/"%(self.channel);
        else: 
        ...
        self.nPV_min=  0;
        self.nPV_max= 300;
        self.vpt_cut= 100;# loose the leptonic W pT cut
		#met cut:el 70; mu: 50
        self.pfMET_cut= 40;# loose MET cut low enough while keeping a fairly pure ttbar sample
        self.lpt_cut = 30;
        if self.channel=="el":
            self.pfMET_cut= 40; 
            self.lpt_cut = 35;        
