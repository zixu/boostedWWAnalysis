 ...
 */
{
	...
	gROOT->ProcessLine(".L RooErfExp_Voig_Gaus_Pdf.cxx+");
...
*/
	...
	RooRealVar width_voig("width_voig","width_voig",5);
	...
	RooErfExp_Voig_Gaus_Pdf g_erfexp_voig_gaus("g_erfexp_voig_gaus","g_erfexp_voig_gaus",x,c,off,width,mean,width_voig,sigma,high,mean2,sigma2,high2);
    ...
    g_erfexp_voig_gaus.plotOn(xframe);
	xframe.Draw();
}
