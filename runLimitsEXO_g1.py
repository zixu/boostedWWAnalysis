...
### submit fit jobs on condor batch
...
if __name__ == '__main__':
    ...
    if (options.computeLimits or options.plotLimits) and options.limitMode == 2 : os.chdir("cards_em_EXO_allCat_v2_ExpN_g1");
    elif (options.computeLimits or options.plotLimits) : os.chdir("cards_em_EXO_allCat_v2_ExpN_g1");
    ...
    if options.computeLimits:
        ...
        for i in range(mLo,mHi):
            ...
            if options.limitMode == 3 :
             ...
             runCmmd += "combine -M MaxLikelihoodFit --minimizerAlgo Minuit2 --minimizerStrategy 2 --rMin %s  --rMax %s -m %03d -n _fit_toy_%03d_%s_HP wwlvj_BulkG_WW_lvjj_c0p2_M%03d_%s_10_00_HP_unbin.txt --toysFrequentist -t 1000 --noErrors --minos none --expectSignal=6.25"%(tmp_rMin,tmp_rMax,mass[i],mass[i],"mu",mass[i],"mu");
             if options.batchMode:
             ...
             runCmmd += "combine -M MaxLikelihoodFit --minimizerAlgo Minuit2 --minimizerStrategy 2 --rMin %s  --rMax %s -m %03d -n _fit_toy_%03d_%s_LP wwlvj_BulkG_WW_lvjj_c0p2_M%03d_%s_10_00_LP_unbin.txt --toysFrequentist -t 1000 --noErrors --minos none --expectSignal=6.25"%(tmp_rMin,tmp_rMax,mass[i],mass[i],"mu",mass[i],"mu");
             if options.batchMode:
             ...
             # el HP
             runCmmd = "combine -M MaxLikelihoodFit --minimizerAlgo Minuit2 --minimizerStrategy 2 --rMin %s  --rMax %s -m %03d -n _fit_%03d_%s_HP wwlvj_BulkG_WW_lvjj_c0p2_M%03d_%s_10_00_HP_unbin.txt\n"%(tmp_rMin,tmp_rMax,mass[i],mass[i],"el",mass[i],"el");
             runCmmd += "combine -M MaxLikelihoodFit --minimizerAlgo Minuit2 --minimizerStrategy 2 --rMin %s  --rMax %s -m %03d -n _fit_toy_%03d_%s_HP wwlvj_BulkG_WW_lvjj_c0p2_M%03d_%s_10_00_HP_unbin.txt --toysFrequentist -t 1000 --noErrors --minos none --expectSignal=6.25"%(tmp_rMin,tmp_rMax,mass[i],mass[i],"el",mass[i],"el");
             if options.batchMode:
             ...
             # el LP
             runCmmd = "combine -M MaxLikelihoodFit --minimizerAlgo Minuit2 --minimizerStrategy 2 --rMin %s  --rMax %s -m %03d -n _fit_%03d_%s_LP wwlvj_BulkG_WW_lvjj_c0p2_M%03d_%s_10_00_LP_unbin.txt\n"%(tmp_rMin,tmp_rMax,mass[i],mass[i],"el",mass[i],"el");
             runCmmd += "combine -M MaxLikelihoodFit --minimizerAlgo Minuit2 --minimizerStrategy 2 --rMin %s  --rMax %s -m %03d -n _fit_toy_%03d_%s_LP wwlvj_BulkG_WW_lvjj_c0p2_M%03d_%s_10_00_LP_unbin.txt --toysFrequentist -t 1000 --noErrors --minos none --expectSignal=6.25"%(tmp_rMin,tmp_rMax,mass[i],mass[i],"el",mass[i],"el");
             if options.batchMode:
            ...
            # combined
             ...
             runCmmd += "combine -M MaxLikelihoodFit --minimizerAlgo Minuit2 --minimizerStrategy 2 --rMin %s  --rMax %s -m %03d -n _fit_toy_%03d_%s wwlvj_BulkG_WW_lvjj_c0p2_M%03d_%s_10_00_unbin.txt --toysFrequentist -t 1000 --noErrors --minos none --expectSignal=6.25"%(tmp_rMin,tmp_rMax,mass[i],mass[i],"em",mass[i],"em");
             if options.batchMode:
    ...
    if options.plotLimits:
        ...
        can.SaveAs("~/limitFigs/pvals_el_HP.C","C");
        ...
        can2.SaveAs("~/limitFigs/pvals_mu_HP.C","C");
        ...
        can3.SaveAs("~/limitFigs/pvals_el_LP.C","C");
        ...
        can4.SaveAs("~/limitFigs/pvals_mu_LP.C","C");
        ...
        can5.SaveAs("~/limitFigs/pvals_em.C","C");
